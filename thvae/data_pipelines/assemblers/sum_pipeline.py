...
from mltoolkit.mldp.steps.collectors import ChunkCollector, \
    ChunkShuffler
from mltoolkit.mldp.steps.collectors.sum_sampler import SumSampler
...
def assemble_sum_pipeline(word_vocab, bart_tokenizer, max_groups_per_batch=1,
    ...
    unit_sampler = SumSampler(id_fname=ModelF.GROUP_ID,
                               sample_all=True,
