...
from mltoolkit.mldp.steps.transformers.nlp.padder_summary import PadderSummary
...
from thvae.data_pipelines.steps import YelpTransformer, RevMapper, \
    AmazonTransformer
from mltoolkit.mldp.steps.formatters import PyTorchFormatter
from thvae.utils.fields import ModelF, AmazonEvalF, YelpEvalF

from thvae.data_pipelines.steps import GoldSummRevIndxsCreator
from mltoolkit.mldp.steps.transformers.nlp.bart_transform import BartTransform



def assemble_eval_pipeline(word_vocab, bart_tokenizer, max_groups_per_chunk=1, dataset='yelp',
    ...
    bart_trans = BartTransform([fn for fn in fields_obj.REVS], bart_tokenizer=bart_tokenizer)
    ...
    padder = PadderSummary(fname=ModelF.REV, new_mask_fname=ModelF.REV_MASK,
