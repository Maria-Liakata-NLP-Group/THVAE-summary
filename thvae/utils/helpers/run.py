...
from thvae.eval.procedures import SummEvalProc
...
def summ_eval(output_folder, data_pipeline, bart_tokenizer, eval_data_source, summ_gen_func,
    ...
    eval_proc = SummEvalProc(data_pipeline, bart_tokenizer=bart_tokenizer, avg_rouge=avg_rouge,
