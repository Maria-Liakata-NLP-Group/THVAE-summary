...
from thvae.eval.metrics.google_rouge.rouge_scorer import RougeScorer
from thvae.eval.metrics.google_rouge.utils import update_moving_avg
...
class GoogleRouge(object):
    ...
    def accum(self, hypotheses, references):
        ...
        for i, hyp in enumerate(hypotheses):
            ...
            # Compute rouges between summary and each reference
