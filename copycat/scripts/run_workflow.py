...
from copycat.data_pipelines.assemblers.sum_pipeline import assemble_sum_pipeline
...
gen_data_sources = [
    # {"data_path": run_hp.train_fp_1, 'early_term': run_hp.gener_early_term},
    # {"data_path": run_hp.val_fp, 'early_term': run_hp.gener_early_term}
    # {"data_path": run_hp.gen_fp3, 'early_term': run_hp.gener_early_term},
    # {"data_path": run_hp.gen_fp4, 'early_term': run_hp.gener_early_term},
    # {"data_path": run_hp.gen_fp5, 'early_term': run_hp.gener_early_term},
    # {"data_path": run_hp.gen_fp6, 'early_term': run_hp.gener_early_term},
    # {"data_path": run_hp.gen_fp7, 'early_term': run_hp.gener_early_term},
    {"data_path": run_hp.gen_add4, 'early_term': run_hp.gener_early_term}
    # {"data_path": run_hp.gen_fp_add, 'early_term': run_hp.gener_early_term}
]
