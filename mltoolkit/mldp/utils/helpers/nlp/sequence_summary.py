...
def pad_sequence(sequence, pad_symbol, max_length,
    ...
    #     len_sequence = sequence.tolist().index(2)+1
    # else:
    #     len_sequence = len(sequence)
    # pad_number = max_length - len_sequence
    ...
    # mask = [s != mask_present_symbol for s in sequence] if \
    #     mask_present_symbol is not None else [1] * len_sequence
    ...
    sequence = pad(sequence, 1, nr_left_pads=nr_left_pads,
