...
from mltoolkit.mldp.utils.helpers.nlp.sequence_summary import pad_sequences as ps
from mltoolkit.mlutils.helpers.general import listify
import numpy as np


class PadderSummary(BaseTransformer):
    """
    ...
    def __init__(self, fname, new_mask_fname, pad_symbol, symbol_to_mask=None,
        ...
        super(PadderSummary, self).__init__(**kwargs)
